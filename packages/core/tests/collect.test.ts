...
import { collectManifest } from "../src/collect";
import type { LocalMutationContext } from "../src/manifest";

// Fake lf.table exports: the same metadata shape @convex-localfirst/server attaches,
